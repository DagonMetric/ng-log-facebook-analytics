...
2. Fork the [repo](https://github.com/dagonmetric/ng-log-facebook-analytics) and create your branch `topic` from master.
...
8. In GitHub, submit a pull request to [dagonmetric/ng-log-facebook-analytics](https://github.com/dagonmetric/ng-log-facebook-analytics).
